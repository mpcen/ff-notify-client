...
export enum FetchSearchedPlayerNewsActionTypes {
    ...
    REFETCH_SEARCHED_PLAYER_NEWS = 'REFETCH_SEARCHED_PLAYER_NEWS',
    REFETCH_SEARCHED_PLAYER_NEWS_SUCCESS = 'REFETCH_SEARCHED_PLAYER_NEWS_SUCCESS',
    REFETCH_SEARCHED_PLAYER_NEWS_FAIL = 'REFETCH_SEARCHED_PLAYER_NEWS_FAIL'
}
